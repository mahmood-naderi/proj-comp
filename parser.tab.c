...
static const char *const yytname[] =
{
  ...
  "LPRAN", "RCURL", "LCURL", "DIGIT", "IDENT", "$accept", "program",
...
#line 1083 "parser.tab.c"
  ...
  case 5: /* function: FUNC IDENT RPRAN LPRAN RCURL LCURL  */
#line 31 "parser.y"
                                             { printf("some random bullshit generated!\n");  }
